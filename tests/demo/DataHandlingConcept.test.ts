...
test("should validated title of web page", { tag: "@constantData" }, async ({ page }) => {
...
test.only("Constant Data Handling ", async ({ page }) => {


    console.log(`The Constant Data Handling ${JSON.stringify(constant.SUCCESCODE)}`)
